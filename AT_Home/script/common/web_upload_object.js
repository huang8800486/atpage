...
(function() {
	...
	var $WebUpload = function(pictureId,img_file) {
	    this.img_src=img_file;
		this.pictureId = pictureId;
		this.uploadBtnId = pictureId + "BtnId";
		this.uploadPreId = pictureId + "PreId";
		this.uploadUrl = Feng.ctxPath + '/user/safe/upload';
	...
	$WebUpload.prototype = {
		...
		bindEvent : function(bindedObj) {
			...
			bindedObj.on('uploadSuccess', function(file,response) {
				...
				$("#" + me.pictureId+"_img").attr("src",me.img_src+ response);
			});
