var GLOBAL_VAR = {
    ...
    button_down: false,
    init: false,
    url: gateways + "/api/market/kline/chart",
    depth: gateways + "/api/market/kline/depth/list"
};
...
String.fromFloat = function(a, c) {
    if (typeof (a) == "undefined") {
        return 0;
    } else if (a == null || typeof (a) == "null" || a == "null" || isNaN(a)) {
        return 0;
    } else {
        return a;
    }
...
MainDataProvider.prototype.getMinMaxAt = function(a, b) {
    // console.log(this._candlestickDS);
    /*if(this._candlestickDS == null){
        this._candlestickDS = 0;
    }*/
...
var refresh_handler = setInterval(refresh_function, 2000);
...
function clear_refresh_counter() {
    ...
    refresh_handler = setInterval(refresh_function, 2000)
};
...
function getklinedataAjaxOne() {
    $.ajax({
        ...
        data: JSON.stringify({ "object": $.toBase64(GLOBAL_VAR.requestParam), "sign": $.toSign($.toBase64(GLOBAL_VAR.requestParam)) }),
        timeout: 30000,
        contentType: "application/json;charset=UTF-8",
        beforeSend: function (xhr) {
            var Authorization = $.getCookies(kTokenKey);
...
function getklinedataAjax() {
    var param = GLOBAL_VAR.requestParam;
    ...
    GLOBAL_VAR.G_HTTP_REQUEST = $.ajax({
            ...
            success: function(json) {
                if (GLOBAL_VAR.G_HTTP_REQUEST) {
                    ...
                    if (!json.code) {
                        alert(json.msg);
                        //kline.refreshPage(json.data.code == 101 ? null : GLOBAL_VAR.market_from);
                        return
                    }

                    GLOBAL_VAR.market_from_name = json.data.marketName;
                    var chart = ChartManager.getInstance().getChart();
                    chart._contract_unit = json.data.contractUnit;
                    chart._money_type = json.data.moneyType;
                    chart._usd_cny_rate = json.data.USDCNY;
                    chart.setTitle();
                    kline.setMarketShow(GLOBAL_VAR.market_from_name, chart._contract_unit, chart._money_type, json.data.url);
                    //kline.setTopTickers(json.data.topTickers);
                    //GLOBAL_VAR.KLineData = eval(json.data.data[json.data.data.length-1]);
					var data = JSON.parse(json.data.data);
					GLOBAL_VAR.KLineData = eval(json.data.data);
					if (data.length > 0) {
						GLOBAL_VAR.date = data[data.length - 1][0];
					}else {
                        GLOBAL_VAR.date = null;
                    }



                    /*if (GLOBAL_VAR.date == null) {
                        GLOBAL_VAR.date = data[data.length - 1][0];
                    }*/
                    /*if (data.length > 0) {
                        GLOBAL_VAR.date = data[data.length - 1][0];
                    }
                    console.log(GLOBAL_VAR.date);*/
                    ...
                    var param = {
                        marketId : GLOBAL_VAR.requestParam.marketId,
                        pageSize : 300
                    };
                    ...
                    $.ajax({
                        ...
                        dataType: "json",
                        // data: GLOBAL_VAR.requestParam,
                        data: JSON.stringify({ "object": $.toBase64(param), "sign": $.toSign($.toBase64(param)) }),
                        timeout: 30000,
                        contentType: "application/json;charset=UTF-8",
                        beforeSend: function (xhr) {
                            var Authorization = $.getCookies(kTokenKey);
                        ...
                        success: function(json) {
							...
